...
* SVWD11, not published, but used to allow local testing of [Shortbread](https://shortbread-tiles.org/schema/1.0/) locally-generated map tiles with the SVWD03 style.
