...
## As yet unreleased
Farmland, forest, grass and residential in the `land1` layer (which is most of it) is now shown at whatever zoom level it was extracted at (8-14).  Names will be shown if extracted.
