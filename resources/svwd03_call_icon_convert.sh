...
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/openstreetmap-carto-AJT/symbols/am_bank3.png                                   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_bank.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/openstreetmap-carto-AJT/symbols/am_bankatm3.png                                ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_bankatm.png
...
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_nnnn.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_nnnn.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_nnny.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_nnny.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_nnyn.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_nnyn.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_nnyy.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_nnyy.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_nynn.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_nynn.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_nyny.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_nyny.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_nyyn.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_nyyn.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_nyyy.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_nyyy.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_ynnn.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_ynnn.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_ynny.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_ynny.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_ynyn.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_ynyn.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_ynyy.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_ynyy.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_yynn.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_yynn.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_yyny.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_yyny.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_yyyn.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_yyyn.png
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/recycling16_yyyy.png   ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_recycling_yyyy.png
#
...
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/openstreetmap-carto-AJT/symbols/food_court.png                                  ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_food_court.png
...
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/openstreetmap-carto-AJT/symbols/leisure_dog_park.png                                ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/leisure_dog_park.png
...
~/src/SomeoneElse-vector-web-display/svwd_convert_icon_from_raster.sh ~/src/openstreetmap-carto-AJT/symbols/playground.p.20.png                             ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/leisure_playground.png
...
cp ~/src/SomeoneElse-vector-web-display/resources/svwd01_source_icons/amenity_place_of_worship_christian_jehovahs_witness.png  ~/src/SomeoneElse-vector-web-display/resources/svwd03_icons/amenity_place_of_worship_christian_jehovahs_witness.png
